# -*- coding: utf-8 -*-
"""34.Домашняя работа Тетерин И.А.
...
"""Для более лучших результатов можно обучать модель дальше, т.к. переобучения на данном этапе не наблюдается. (закончились ресурсы в колабе)"""
